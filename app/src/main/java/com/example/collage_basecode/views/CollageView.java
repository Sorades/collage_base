...
package com.example.collage_basecode.views;
 ...
 * tree .  It basically keeps a reference to one VisualElement object, which is presumed
 * to be the root of an VisualElement tree, and arranges to draw it.  Since there is no
 * explicit damage management as part of the VisualElement API, to force a redraw of
 * the VisualElement tree you can call <code>invalidate()</code> on this host object.
 */
